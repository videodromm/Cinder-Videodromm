...
void VDSettings::reset()
{
	...
	mMixFragmentShaderString = "#version 150\n"
		...
		"	}\n"
		"	// sobel\n"
		"	if (iSobel > 0.03) { left = sobel0(iSobel * 3.0 /iResolution.x, iSobel * 3.0 /iResolution.y, uv) * iColor; }\n"
		"	// Trixels\n"
		...
		"	}\n"
		"	// sobel\n"
		"	if (iSobel > 0.03) { right = sobel1(iSobel * 3.0 /iResolution.x, iSobel * 3.0 /iResolution.y, uv) * iColor; }\n"
		"	// Trixels\n"
